...
Gradus.jl is developed by:

- Dr. Fergus Baker (Newcastle University)
- Dr. Andrew Young (University of Bristol)

with thanks to `$CONTRIBUTORS` (see the repository for the full list).

For more Astrophysics Group codes, see [our Codeberg organisation](https://codeberg.org/astro-group).
