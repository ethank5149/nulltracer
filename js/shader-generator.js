// ============================================================
//  SHADER GENERATOR
//  Generates GLSL fragment shader source for the Kerr-Newman
//  black hole geodesic ray tracer.
// ============================================================

export function buildFragSrc(opts) {
    const STEPS = opts.steps || 200;
    const METHOD = opts.method || 'yoshida4';
...
//
//  Coefficients from Yoshida (1990), Physics Letters A,
...
//
//  Coefficients from Yoshida (1990), Physics Letters A,
//  150(5-7), 262-268, Table 2 "Solution D" for order 8.
// ===========================================================
...
//
//  The classic 4th-order symplectic composition method.
//  3 substeps with triple-jump coefficients.
//
