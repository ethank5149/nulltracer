...
_LAZY_IMPORTS = {
    ...
    "extract_ring_diameter": ".eht_validation",
    "M_to_uas": ".eht_validation",
    "uas_per_M": ".eht_validation",
    "EHT_M87": ".eht_validation",
    "EHT_SGRA": ".eht_validation",
    "GARGANTUA": ".eht_validation",
